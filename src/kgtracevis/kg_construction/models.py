...
KG_CONSTRUCTION_ARTIFACT_FILENAMES: dict[str, str] = {
    ...
    "document_understanding_manifest": "document_understanding_manifest.json",
    "document_map": "document_map.json",
    "chunk_prompt_context": "chunk_prompt_context.jsonl",
    "cross_chunk_proposals": "cross_chunk_proposals.jsonl",
    "brainstorm_hypotheses": "brainstorm_hypotheses.jsonl",
    "brainstorm_evidence_tasks": "brainstorm_evidence_tasks.jsonl",
    "brainstorm_profile_gaps": "brainstorm_profile_gaps.json",
    "brainstorm_review_items": "brainstorm_review_items.json",
    "hypothesis_brainstorming_manifest": "hypothesis_brainstorming_manifest.json",
    "alignment_suggestions": "alignment_suggestions.jsonl",
    "semantic_layer_suggestions": "semantic_layer_suggestions.jsonl",
    "profile_gap_suggestions": "profile_gap_suggestions.json",
    "accepted_alignment_overrides": "accepted_alignment_overrides.json",
    "accepted_profile_gaps": "accepted_profile_gaps.json",
    "accepted_hypotheses": "accepted_hypotheses.json",
    "accepted_evidence_tasks": "accepted_evidence_tasks.json",
