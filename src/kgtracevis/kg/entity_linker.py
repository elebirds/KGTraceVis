    ...
    for mention_item in _iter_mentions(evidence):
        ...
        links.append(
            _link_payload(
                ...
                selected_entity_name=selected.name,
                selected_entity_scenario=selected.scenario,
...
def _link_payload(
    ...
    *,
    ...
    selected_entity_scenario: str | None = None,
    score: float = 0.0,
    ...
    payload: dict[str, Any] = {
        ...
        "selected_entity_scenario": selected_entity_scenario,
        "score": score,
